...
public class PlayerAttack : MonoBehaviour
{
    ...
    void ComboAttacks() {
        ...
        {
            //if the current combo is kick 2 or punch 3
            //return means exit because we have no combo to perform
            ...
            //then we can set the current combo state to kick 1 to chain the combo
